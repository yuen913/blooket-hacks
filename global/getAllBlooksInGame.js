(async () => {
    ...
    window.alert = n.contentWindow.alert.bind(chrome book);
    window.prompt = n.contentWindow.prompt.bind(chrome book);
    window.confirm = n.contentWindow.confirm.bind(chrome book);
    n.remove();
